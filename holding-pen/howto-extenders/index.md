...
This guide will walk you through how to use an [extender]({{< ref "/guides/resource-types/custom-resource-types/overview#extenders" >}}) in an application to model resources beyond those currently built into Radius. These might be abstractions or resources unique to your organization, or resources that don't yet have a native Radius type.

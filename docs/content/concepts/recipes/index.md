...
1. Sets up authentication to OCI registries where Bicep templates are stored using configurations in the Environment.
1. Sets up authentication to Git repositories where Terraform modules are stored using configurations in the Environment.

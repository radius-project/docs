...
{{% codetab %}}
In the following example, a [Container]({{< ref "/author-apps/containers" >}}) is connecting to an Azure Cache for Redis resource. The Container is assigned the `Redis Cache Contributor` role:

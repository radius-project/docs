...
The following examples show how a [container]({{< ref "/author-apps/containers" >}}) can connect to a Redis link, which in turn binds to an Azure Cache for Redis or a Kubernetes Pod.

...
| **host** | string | The hostname of the RabbitMQ instance <br />_(ReadOnly)_ |
...
| **vHost** | string | The RabbitMQ virtual host (vHost) the client will connect to. Defaults to no vHost. <br />_(ReadOnly)_ |

...
Open the `app.bicep` and add the following Radius resources:
...
1. Deploy your application to your environment:
   ...
   Radius is currently working on supporting [direct connections]({{< ref "appmodel-concept#adding-connections" >}}) to AWS resources so that your container can automatically communicate with the data store securely{{% /alert %}}

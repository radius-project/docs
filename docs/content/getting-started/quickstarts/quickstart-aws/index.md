...
1. Use the `rad init` command to initialize a new environment into your current kubectl context:
   ...
   Follow the prompts to install Radius, create an [environment resource]({{< ref environments-resource >}}), and create a [local workspace]({{< ref workspaces >}}). You will be asked for:

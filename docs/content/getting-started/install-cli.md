...
1. Download the `rad` CLI from one of these URLs:
   ...
   - MacOS: https://get.radapp.dev/tools/rad/0.10/macos-x64/rad
   - Linux: https://get.radapp.dev/tools/rad/0.10/linux-x64/rad
   - Windows: https://get.radapp.dev/tools/rad/0.10/windows-x64/rad.exe

...
<br> {{<button text="Next step: Swap connector resource" page="webapp-swap-connector-resource" newline="false">}} {{<button text="Previous step: Author app definition" page="webapp-initial-deployment">}}

...
Create a new Bicep resource that represents your [application]({{< ref app-model-overview >}}). This is the parent resource which will contain all of your services and relationships:

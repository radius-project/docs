...
- [Supported Kubernetes cluster]({{< ref "/guides/setup-platform/kubernetes/overview#supported-kubernetes-clusters" >}})
...
Begin by creating a file named `app.bicep` with a Radius [container]({{< ref "guides/resource-types/core-resource-types/containers" >}}):
...
- [Dapr in Radius containers]({{< ref "/guides/resource-types/core-resource-types/containers/overview#kubernetes" >}})

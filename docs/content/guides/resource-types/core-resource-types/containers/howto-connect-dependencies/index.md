...
This how-to guide will teach how to connect to your dependencies via [connections]({{< ref "guides/resource-types/core-resource-types/containers#connections" >}})
...
Open the `app.bicep` and view the [container]({{< ref "guides/resource-types/core-resource-types/containers" >}}):

{{< rad file="snippets/app.bicep" embed=true >}}

## Step 2: Add a Redis cache as a dependency

Next, add to `app.bicep` a [Redis cache]({{< ref "/guides/resource-types/portable-resource-types/overview" >}}), leveraging the default "local-dev" Recipe:
...
- [Connections]({{< ref "guides/resource-types/core-resource-types/containers/overview#connections" >}})

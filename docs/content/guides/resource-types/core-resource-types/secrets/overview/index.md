...
Follow the [how-to guide on creating new secret store]({{< ref "/guides/resource-types/core-resource-types/secrets/howto-new-secretstore" >}}) to learn more about creating a new secret store resource and storing a TLS certificate in it.
...
Secret Stores can currently be used for TLS certificates with [Radius Gateways]({{< ref "/guides/resource-types/core-resource-types/networking/overview#gateways" >}}).

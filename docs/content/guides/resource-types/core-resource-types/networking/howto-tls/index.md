...
TLS certificates need to be referenced via a Radius [secret store]({{< ref "/guides/resource-types/core-resource-types/secrets" >}}). You can either reference an existing secret, or define a new one with certificate data.
...
- [Networking overview]({{< ref "/guides/resource-types/core-resource-types/networking/overview" >}})

---
type: docs
title: "Overview: Portable Resource Types"
linkTitle: "Overview"
...
Portable resource types provide **abstraction** and **portability** to Radius Applications. This allows development teams to depend on high level resource types and APIs, and let infra teams swap out the underlying resource and configuration.
...
The following portable resource types are available to use within your application:
...
Refer to the [API reference docs]({{< ref "/concepts/technical/api" >}}) to learn more about the Radius API and the available portable resource types plus their schema
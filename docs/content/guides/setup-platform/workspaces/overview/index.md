...
Workspaces allow you to manage multiple Radius [environments]({{< ref "/guides/setup-platform/environments/overview" >}}) using a local, client-side, configuration file. You can easily define and switch between workspaces to deploy and manage applications across separate environments.

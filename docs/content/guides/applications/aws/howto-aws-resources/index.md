...
Follow the prompts to install Radius , create an [environment resource]({{< ref "/guides/environments/environments" >}}), and create a [local workspace]({{< ref workspaces >}}). You will be asked for:

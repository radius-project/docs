...
The following steps show you how to configure the Radius to send distributed tracing data to Zipkin running as a container in your Kubernetes cluster and how to view the data.

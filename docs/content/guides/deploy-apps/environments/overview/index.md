...
1. Begin by deploying a compatible [Kubernetes cluster]({{< ref "guides/operations/kubernetes" >}})

   *Visit the [Kubernetes platform docs]({{< ref "guides/operations/kubernetes" >}}) for a list of supported clusters and specific cluster requirements.*

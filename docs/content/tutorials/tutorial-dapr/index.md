...
- How [Dapr and Radius]({{< ref "guides/resource-types/core-resource-types/dapr" >}}) seamlessly work together
...
- [Setup a supported Kubernetes cluster](https://docs.radapp.io/guides/setup-platform/kubernetes/overview/#supported-clusters)
...
Add a `frontend` [container]({{< ref "guides/resource-types/core-resource-types/containers" >}}) which will serve as the application's user interface.
